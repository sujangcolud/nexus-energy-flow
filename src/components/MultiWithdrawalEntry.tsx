      ...
      <DialogContent className="max-w-5xl w-[95vw] max-h-[95vh] overflow-y-auto p-4 md:p-6 rounded-3xl" aria-describedby={undefined}>
          ...
          {rows.map((r, i) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:items-end">
                ...
                <div className="md:col-span-2">
                  <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground mb-1.5 block">Amount (₹)</Label>
                  <Input
                    type="number"
                    value={r.amount}
                    className="h-11 rounded-xl font-bold border-border"
                ...
                <div className="md:col-span-2">
                  <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground mb-1.5 block">Purpose</Label>
                  <Input
                    value={r.purpose}
                    className="h-11 rounded-xl font-bold border-border"
                ...
                <div className="md:col-span-2">
                  <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground mb-1.5 block">Recipient</Label>
                  <Input
                    value={r.recipient}
                    className="h-11 rounded-xl font-bold border-border"
                ...
                <div className="md:col-span-1">
                  <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground mb-1.5 block">From</Label>
                  <Select
        ...
        <DialogFooter className="mt-8 flex flex-col sm:flex-row items-center gap-4 border-t border-border pt-6">
          <div className="flex-1 text-center sm:text-left">
            <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Batch Total Withdrawals</p>
