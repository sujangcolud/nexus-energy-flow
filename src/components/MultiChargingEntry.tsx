            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:items-end">
                ...
                <div className="grid grid-cols-2 md:col-span-3 gap-3">
                  ...
                  <div>
                    <Label className="text-[10px] font-black uppercase tracking-wider text-slate-400 mb-1.5 block">End %</Label>
                    <Input
                      type="number"
                ...
                <div className="grid grid-cols-2 md:col-span-3 gap-3">
                  <div>
                    <Label className="text-[10px] font-black uppercase tracking-wider text-slate-400 mb-1.5 block">kCal/Unit</Label>
                    <Input
                      type="number"
                      value={r.kcal}
                      className="h-11 rounded-xl font-bold border-slate-200"
                  ...
                  <div>
                    <Label className="text-[10px] font-black uppercase tracking-wider text-slate-400 mb-1.5 block">Unit Rate</Label>
                    <Input
                      type="number"
