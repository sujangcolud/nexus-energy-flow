-- FINAL CORRECTED Daily Summary Synchronization Script
...
BEGIN
    ...
    INSERT INTO daily_summary (
        summary_date,
        -- Orders totals (exact column names)
        ...
        -- Charging totals (exact column names)
        ...
        -- Expenses totals (exact column names)
        total_expenses,
        total_expenses_cash,
        total_expenses_esewa,
        total_expenses_fonepay,
        -- Deposits totals (exact column names)
        total_deposits,
        total_deposits_cash,
        total_deposits_esewa,
        -- Withdrawals totals (exact column names from your schema)
        total_withdrawals,
        ...
        -- Savings totals (exact column names)
        total_savings,
        total_savings_cash,
        total_savings_esewa,
        total_savings_fonepay,
        -- Current balances (exact column names from your schema)
        cash_balance,
        esewa_balance,
        fonepay_balance,
        cooperative_balance,
        total_balance,
        -- Duplicate income columns (they exist in your schema)
        total_income_cash,
        total_income_esewa,
        ...
        -- Withdrawals totals (using exact schema columns)
        ...
        balances_data.cash_balance + balances_data.esewa_balance + balances_data.fonepay_balance + balances_data.cooperative_balance, -- total_balance
        -- Duplicate income columns
